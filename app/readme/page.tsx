  ...
  return (
    <main className="max-w-2xl mx-auto flex flex-col px-6 pt-6 sm:pt-12 pb-16 relative container font-mono">
      <div className="flex items-center gap-2 mb-6 pb-3 border-b border-[#e5e5e5] dark:border-[#262626]">
        ...
        <span className="text-3xs text-black/30 dark:text-white/30 ml-auto">
      ...
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-black dark:text-white leading-tight">
          <span className="text-emerald-500/70 dark:text-emerald-400/70 mr-2 select-none">
            #
          </span>
          {t('readme.title')}
        </h1>
        ...
        <div className="rounded-lg border border-[#e5e5e5] dark:border-[#262626] overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-2 bg-black/3 dark:bg-white/3 border-b border-[#e5e5e5] dark:border-[#262626]">
            <Icon
              ...
              className="size-3.5 text-black/40 dark:text-white/40"
            />
            <span className="text-3xs text-black/40 dark:text-white/40">
              terminal
            </span>
          </div>
          <div className="p-4 bg-black/2 dark:bg-white/2">
            <pre className="text-sm text-black/80 dark:text-white/80 leading-relaxed overflow-x-auto">
              <code>
                <span className="text-black/40 dark:text-white/30 select-none">
                  $
                </span>{' '}
            ...
            <ul className="text-sm space-y-2.5">
              {stack.map((item) => (
                <li key={item.name} className="flex items-start gap-2">
                  <span className="text-emerald-500/70 dark:text-emerald-400/70 select-none mt-0.5 shrink-0">
                    -
                  </span>
                  <div>
                    ...
                    <span className="text-black/40 dark:text-white/40 mx-1.5">
                      —
                    </span>
                    <span className="text-black/60 dark:text-[#f0f7ff9e]">
                      {item.desc}
                    </span>
                  </div>
                </li>
      ...
      <section className="mb-8">
        ...
        <ol className="text-sm text-black/60 dark:text-[#f0f7ff9e] leading-relaxed space-y-2 pl-1">
          <li className="flex items-start gap-2">
            <span className="text-black/40 dark:text-white/30 select-none font-medium shrink-0">
              1.
            </span>
            {t('readme.feature_1')}
          </li>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-black/50 dark:text-white/40 mb-4">
      ...
      <section className="mb-4">
        ...
        <p className="text-sm text-black/60 dark:text-[#f0f7ff9e]">
